                ...
                <div className="dash-waka-data">
                  {wakaStats.totalCodingTime && (
                    <div className="dash-waka-total">
                      <span className="dash-waka-total-label">LAST 7 DAYS TOTAL</span>
                      <span className="dash-waka-total-value">{wakaStats.totalCodingTime}</span>
                    </div>
                  )}
                  {wakaStats.dailyAverage && (
                    <div className="dash-waka-total" style={{ marginTop: '12px' }}>
                      <span className="dash-waka-total-label">DAILY AVERAGE</span>
                      <span className="dash-waka-total-value">{wakaStats.dailyAverage}</span>
                    </div>
                  )}

                  {wakaStats.editors && wakaStats.editors.length > 0 ? (
                    <div className="dash-waka-editors" style={{ marginTop: '24px', marginBottom: '16px' }}>
                      <span className="dash-waka-total-label">EDITORS USED</span>
                      <div className="dash-editors-list" style={{ display: 'flex', gap: '15px', flexWrap: 'wrap', marginTop: '8px' }}>
                        {wakaStats.editors.map(editor => (
                          <div key={editor.name} style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                            <span style={{ fontSize: '1.2rem' }}>⌨️</span>
                            <span style={{ color: '#fff', fontSize: '0.9rem', fontWeight: 500 }}>{editor.name}</span>
                            <span style={{ color: '#8A9BAD', fontSize: '0.8rem' }}>({editor.percentage}%)</span>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="dash-waka-editors" style={{ marginTop: '24px', marginBottom: '16px' }}>
                      <span className="dash-waka-total-label">EDITORS USED</span>
                      <div style={{ color: '#8A9BAD', fontSize: '0.9rem', marginTop: '8px' }}>No editor data for this period</div>
                    </div>
                  )}

                  {wakaStats.languages && wakaStats.languages.length > 0 ? (
                    <div style={{ marginTop: '24px' }}>
                      <span className="dash-waka-total-label" style={{ marginBottom: '12px', display: 'inline-block' }}>TOP LANGUAGES</span>
                    ...
                    <div style={{ marginTop: '24px' }}>
                      <span className="dash-waka-total-label" style={{ marginBottom: '12px', display: 'inline-block' }}>TOP LANGUAGES</span>
                      <div style={{ color: '#8A9BAD', fontSize: '0.9rem' }}>No language data for this period</div>
                    </div>
                  )}
                </div>
              )}
